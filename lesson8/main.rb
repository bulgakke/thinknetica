...
class Menu
  ...
  def create_route # 3
    ...
    return unless first_station && last_station
      ...
      @trains.each do |train|
        ...
        train.each_wagon do |wagon|
          ...
          if wagon.type == 'Passenger'
            puts "Overall seats: #{wagon.number_of_seats}; free: #{wagon.seats_free}; taken: #{wagon.seats_taken}"
          end
          if wagon.type == 'Cargo'
            puts "Overall cargo volume: #{wagon.cargo_volume}; free: #{wagon.volume_free}; taken: #{wagon.volume_taken}"
          end
          wagon_number += 1
        end
      end
  ...
  def manage_train # 7
    ...
    when 2 # Manage a train > Add wagons
      ...
      wagons_to_add = gets.to_i until wagons_to_add.positive?

      (1..wagons_to_add).each do |_counter|
        ...
        next unless train_to_manage.class == PassengerTrain
    ...
    when 6 # Manage a train > Load cargo or sit passengers
      ...
      input = gets.to_i until (0..train_to_manage.wagons.size).include?(input - 1)
